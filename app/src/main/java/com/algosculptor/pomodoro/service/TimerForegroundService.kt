...
import com.algosculptor.pomodoro.PomodoroApp
...
class TimerForegroundService : Service() {
    ...
    private fun buildNotification(snap: com.algosculptor.pomodoro.timer.EngineSnapshot): Notification {
    ...
    companion object {
        ...
        const val ACTION_PAUSE = "com.algosculptor.pomodoro.action.PAUSE"
        const val ACTION_RESUME = "com.algosculptor.pomodoro.action.RESUME"
        const val ACTION_SKIP = "com.algosculptor.pomodoro.action.SKIP"
        const val ACTION_RESET = "com.algosculptor.pomodoro.action.RESET"
